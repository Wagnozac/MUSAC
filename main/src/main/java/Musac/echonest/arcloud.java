...
public class arcloud {
    ...
    public static void main(String[] args) {
        ...
        config.put("access_key", "551209f5ec1d88484146e3e328e33584");
        config.put("access_secret", "jhWaVK0fFHDxrEde6ZdeFNTTvibyfcbvmFoT8r9U");
        config.put("debug", false);
        config.put("timeout", 15); // seconds
        ...
        String result = re.recognizeByFile("ressources\\Always.mp3", 80);
        ...
        /**
          ...
          * 
          **/
        File file = new File("ressources\\Always.mp3");
